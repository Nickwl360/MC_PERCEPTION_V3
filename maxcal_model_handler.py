...
from mc_model import maxcal_functions as mc
...
class BrainModel:
    ...
    def __init__(self, I, NR,NE, dt, HC='100', VC='100',joch_data=False):
        ...
        self.perception_cl_prog = os.path.join(current_dir, 'mc_model/mc_perception_opencl.cl')
    ...
    def find_model(self, initial_guess=None):
        ...
        self.initial_guess=[-9.25561687, -9.11781213, -6.92073347 ,-2.58308621,  0.661547 ,   2.03336645,
  2.97171867 , 0.13340081 , 0.85122116]
